...
from utils.loss_utils import l1_loss, ssim, edge_aware_smooth_loss
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    if args.train_mvs_prune:
        start_point = ast.literal_eval(opt.start_point) 
        mvs_prune_thresholds = ast.literal_eval(opt.mvs_prune_thresholds) 
