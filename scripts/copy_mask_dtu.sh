base="/media/xyr/data11/code/3DGS/gaussian-splatting-wdepth/gaussian-splatting-diff-depth/gaussian-splatting/output/sa/dtu_3"
mask_path="/media/xyr/data22/datasets/datasets/dtu/submission_data/idrmasks"
